...
//Delay added to fix the display screen
...
#define STRING_CONFIG_H_AUTHOR "(MarceloFuture, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FutureClay"
...
#define DELTA_PRINTABLE_RADIUS 90.0 //128.0 // (mm)
...
#define DELTA_HEIGHT 214.00 // (mm) Get this value from G33 auto calibrate
...
#define DELTA_RADIUS 89.0 // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT                                                         \
  {                                                                                         \
    DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 400 \
 ...
 */
#define DEFAULT_ACCELERATION 3000         // 500    // X, Y, Z and E acceleration for printing moves
...
#define JUNCTION_DEVIATION_MM 0.013 // 0.08  // (mm) Distance from real junction edge
...
#define PROBING_MARGIN 25 // 30

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_SPEED (83 * 60) // (133*60)
...
#define Z_PROBE_OFFSET_RANGE_MIN -64
#define Z_PROBE_OFFSET_RANGE_MAX 64
...
#define X_MIN_POS -200 // 0
#define Y_MIN_POS -200 // 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE / 2
#define Y_MAX_POS Y_BED_SIZE / 2
#define Z_MAX_POS MANUAL_Z_HOME_POS // 250
...
#define MANUAL_Z_HOME_POS 392.0
